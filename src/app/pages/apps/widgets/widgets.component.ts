...
import { tileBoxs1, tileBoxs2, tileBoxs3, tileBoxs4, otherWidgets, widgetsActivities, widgetsTasks, basicBarChart, tileBoxs5, hotproducts, candidate, bank } from './data';
